...
<template>
  ...
  >
    ...
    <!-- <router-link
      to="/about"
      class="font-[600] block text-left text-lg font-medium text-primary-dark dark:text-ternary-light hover:[#5cc928] dark:hover:text-indigo-300 sm:mx-4 mb-2 sm:py-2 border-t-2 pt-3 sm:pt-2 sm:border-t-0 border-primary-light dark:border-secondary-dark"
      aria-label="About Me"
